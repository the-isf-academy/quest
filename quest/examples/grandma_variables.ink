...
=== VEGGIES ===
I just need a few things. I need {veggies}.

Oh, and can't forget a mushroom!

+ OK, I'll find {veggies} -> END

=== CARROTS ===
Oh, these are lovely carrots. But I still need {num_veggies_left} more vegetables.
...
=== POTATOES ===
Oh, these are very spuddy potatoes. But I still need {num_veggies_left} more vegetables.

+ OK -> END

=== MUSHROOM ===
Oh, what a beautiful mushroom. It reminds me of my girlhood. But I still need {num_veggies_left} more vegetables.
