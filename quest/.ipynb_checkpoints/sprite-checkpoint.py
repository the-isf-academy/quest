...
>>>>>>> 6d700578958f5791cafca392757db534068f9468
    ...
    def __init__(self):
        ...
        self.textures.append(texture)
        texture = arcade.load_texture(":resources:examples/piratetop.00.17 PM.png")
        self.textures.append(texture)
        texture = arcade.load_texture(":resources:examples/piratetop.00.17 PM.png", mirrored=True)
        self.textures.append(texture)
